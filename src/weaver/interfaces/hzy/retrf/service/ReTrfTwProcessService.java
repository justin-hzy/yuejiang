...
public class ReTrfTwProcessService extends BaseBean {

    public void createReTrfTwProcess(RequestInfo requestInfo){
    ...
    public List<Map<String,String>> getTrfDt4(String requestid){

        RecordSet dtRs = new RecordSet();

        String sql = "select sku hpbh,sum(retrf_qty) sl from formtable_main_263 main inner join formtable_main_263_dt4 dt4 on main.id = dt4.mainid where main.requestid = ? group by sku";
