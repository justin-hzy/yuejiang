...
public class TransReSaleGyjTwReOrderService extends BaseBean {
    ...
    public String putGyjTwReSale(String requestid){
        ...
        String resStr = doK3Action(param,k3Ip,putGyjTwReSaleUrl);
