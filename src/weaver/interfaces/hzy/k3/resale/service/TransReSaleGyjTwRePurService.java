...
public class TransReSaleGyjTwRePurService extends BaseBean {

    private String k3Ip = getPropValue("fulun_api_config","k3Ip");

    private String putGyjTwRePurUrl = getPropValue("k3_api_config","putGyjTwRePurUrl");

    private String getTwPurPriceUrl = getPropValue("k3_api_config","getTwPurPriceUrl");

    public String putGYJTwRePur(String requestid){
        writeLog("执行putGYJTwRePur");
        ...
        String resStr = doK3Action(param,k3Ip,putGyjTwRePurUrl);
