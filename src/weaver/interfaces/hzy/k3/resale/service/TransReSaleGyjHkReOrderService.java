...
public class TransReSaleGyjHkReOrderService extends BaseBean {
    ...
    private String putGyjHkReSaleUrl = getPropValue("k3_api_config","putGyjHkReSaleUrl");

    public String putGyjHkReSale(String requestid){
        writeLog("执行putGyjHkReSale");
        ...
        String resStr = doK3Action(param,k3Ip,putGyjHkReSaleUrl);
