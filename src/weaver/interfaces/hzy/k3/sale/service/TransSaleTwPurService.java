...
public class TransSaleTwPurService extends BaseBean {
    ...
    public String getDtl(String requestid,JSONObject jsonObject){
        String dt1Sql = "select dt1.tm,dt1.sl,dt1.xsj " +
    ...
    public void getPrice(String sku,JSONObject dt1Json){
        ...
        String fTaxPrice = doK3Action(jsonObject.toJSONString(),k3Ip,"/dmsK3Service/k3/getPrice");
