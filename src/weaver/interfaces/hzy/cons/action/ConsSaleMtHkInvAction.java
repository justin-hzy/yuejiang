...
public class ConsSaleMtHkInvAction extends BaseBean implements Action {

    @Override
    public String execute(RequestInfo requestInfo) {
        writeLog("ConsSaleMtHkInvAction开始执行");
        ...
        //寄售-发货店仓(销售)
        String warehouseCode = mainData.get("fhdcxs");
        ...
        if(respMap.containsKey("hkNotEnoughList")){
            ...
            if(CollUtil.isNotEmpty(hkNotEnoughList)){
                ...
                String updateSql = "update formtable_main_238 set hk_status  = ?,is_hk_enough = ?,error_message = ? where requestid = ? ";
        ...
        writeLog("ConsSaleMtHkInvAction执行完毕");
