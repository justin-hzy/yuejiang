...
public class PutConsSaleThaOrderService extends BaseBean {
    ...
    public String getDtl(String requestid,JSONObject jsonObject){
        ...
        String dt1Sql = "select dt1.sku_no,dt1.qty,dt1.ftaxprice from formtable_main_270 as main " +
                "inner join formtable_main_270_dt1 as dt1 on main.id = dt1.mainid " +
                "where requestid = ? and dt1.qty > 0 and dt1.qty is not null";
